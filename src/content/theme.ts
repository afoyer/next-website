...
// Theme colours
//
// Every key becomes a CSS variable (`navBg` → `--nav-bg`) with the light or
// dark value applied depending on the current theme. Tailwind classes such
// as `bg-nav-bg` are mapped to these variables in src/app/globals.css.
//
// To add a colour: add a key here, then add a matching
// `--color-<name>: var(--<name>);` line in globals.css.
// ─────────────────────────────────────────────────────────────────────────────
