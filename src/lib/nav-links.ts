...
export const NAV_SECTIONS: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'presence of light', href: '/projects/presence', gradient: '#6050a0', preview: '/images/gifs/presence-ascii.gif'  },
    ],
  },
  {
    id: 'work',
...
export const TAB_LABELS = Object.fromEntries(
  NAV_SECTIONS.map(s => [s.id, s.label])
) as Record<Tab, string>;

export const NAV_ITEMS = Object.fromEntries(
  NAV_SECTIONS.map(s => [s.id, s.items])
) as Record<Tab, NavItem[]>;
