export type NavItem = {
	...
	href: string;
	gradient: string;
	preview?: string; // animated ascii gif — navbar & ripple transition
	frame?: string; // raw photo for the ascii-background renderer; falls back to default
	external?: boolean;
};
	...
	},
	{
		...
		items: [
			...
			},
			{
				...
				frame: "/images/nav2/radiosity.jpg",
			},
			{
