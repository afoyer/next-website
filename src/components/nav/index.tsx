...
export default function Navigation() {
	...
	const previewImgContainerRef = useCallback(
	...
	return (
		<motion.div animate={{ opacity: 1 }}>
			<AnimatePresence mode="wait" initial={true}>
				{isLanding ? (
					/* // ── /landing-page label ────────────────────────────────────────── */
					<LandingNavHeader key="landing-header" />
				) : (
					// ── main nav ─────────────────────────────────────────────────────
					<motion.div
						key="nav"
							...
							>
								...
								{!isMobile && (
									<div className={styles.header}>
										...
										<motion.div
											className={`${styles.logo_tile} ${!isOpen ? styles.logo_tile_blend : ""}`}
											animate={{
										...
										>
											<Link href="/" className={styles.logo_btn} aria-label="Home">
												<Logo className={!isOpen ? styles.logo_svg_blend : styles.logo_svg} />
											</Link>
										</motion.div>
										...
										<AnimatePresence mode="wait" initial={false}>
											{isOpen ? (
												...
												<motion.div
													...
													transition={{ duration: 0.15 }}
												>
													<div className={styles.logo_tile} style={{ borderRadius: "10px 0 0 0" }}>
														<button
															type="button"
													...
													<div className={styles.logo_tile}>
														<Link href="/" className={styles.logo_btn} aria-label="home">
															<Home />
														</Link>
													</div>
